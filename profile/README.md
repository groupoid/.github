...
* **Модульність** — окремі мови та компоненти можуть використовуватися незалежно або як частини великої системи AXIO.
* **Академічна спрямованість** — підтримка воркшопів, презентацій та освітніх матеріалів для поширення формальних методів.
