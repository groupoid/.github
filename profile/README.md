...
<a href="https://tonpa.guru/stream/2026/2026-03-24%20On%20Authorship.htm">Детальніше про авторство в Групоїд Інфініті</a>.
...
Groupoid Infinity є частиною досліджень <a href="https://github.com/synrc/">Synrc Research</a>, присвячених формальним мовам, залежним типам та механічній верифікації математики. Лабораторія підтримує освітні ініціативи, воркшопи та публікацію матеріалів з HoTT і сучасної категорійної математики.
